...
do 
    case "${option}"
        ...
        Usage: 
            ...
            Ex:
                RHEL: rhel9_arm, rhel9, rhel9.1_arm, rhel9.1, rhel9.2_arm, rhel9.2 (rhel x86 versions are packer generated modified ami's for enable fips/disable ntwk mgmt; arm versions unedited)
                SLES: sles15sp4_arm, sles15sp4
                Ubuntu: ubuntu22.4, ubuntu22.4_arm, ubuntu20.4, ubuntu20.4_arm
                Oracle Linux: OL8.7 (packer edit version), OL8.8, OL9, OL9.1 (packer edit version), OL9.2 (did not find arm version)
                Rocky: rocky8.7, rock8.8, rocky8.8_arm, rocky9, rocky9.1, rocky9.2 (unmodified ami's)
